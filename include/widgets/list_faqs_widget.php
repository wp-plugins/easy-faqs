...
class listFAQsWidget extends WP_Widget
{
	...
	function widget($args, $instance){
		...
		echo $easy_faqs->outputFAQs(array('count' => $count, 'read_more_link_text' => $faq_read_more_link_text, 'read_more_link' => $faq_read_more_link, 'show_thumbs' => $show_faq_image, 'order' => $order, 'orderby' => $order_by, 'quicklinks' => $quick_links, 'colcount' => $quick_links_columns, 'style' => $accordion_style, 'category' => $category));
